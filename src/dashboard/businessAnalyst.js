      ...
      <div className="business-analyst-class">
        ...
        <div className="class-description">
          <div className="description-top">
           ...
           <p id="description">Out of nowhere we can still find confusion in business analyst. Here, we will help you to understand the errors and answering all your questions of your own problem.</p>
          </div>
          <div className="preparation">
            <p id="title">What to bring to the class ?</p>
            <ul id="list">
              <li>Laptops.</li>
              <li>Your problems of business analyst.</li>
              <li>Stationary</li>
            </ul>
          </div>
          <div className="tutor">
            ...
            <div className="tutor-description">
              ...
              <p id="job-title">Business Analyst at Bukalapak</p>
