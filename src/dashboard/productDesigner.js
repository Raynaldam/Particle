...
import '../css/productDesigner.css';

class ProductDesigner extends Component {
  render() {
    return (
      <div className="product-designer-class">
        <div className="description">
         <p id="title">Understand a bit of what others want.</p>
        ...
        <div className="class-description">
          <div className="description-top">
           ...
           <p id="description">Out of nowhere we can still find confusion in designing products. Here, we will help you to understand the errors and answering all your questions of your own problem.</p>
          </div>
          <div className="preparation">
            <p id="title">What to bring to the class ?</p>
            <ul id="list">
              <li>Laptops.</li>
              <li>Your problems of product design.</li>
              <li>Stationary</li>
            </ul>
          </div>
          <div className="tutor">
            ...
            <div className="tutor-description">
              ...
              <p id="job-title">Product Designer at Bukalapak</p>
